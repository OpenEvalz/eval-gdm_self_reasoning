#!/usr/bin/env python3
"""Run ONE problem of gdm_self_reasoning through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/gdm_self_reasoning_approved_directories"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one gdm_self_reasoning problem via TrustedRouter")
